...
\title{ \normalsize \textsc{First Year Project - BSFIYEP1KU}
		\\ [2.0cm]
		\HRule{0.5pt} \\
		\LARGE \textbf{\uppercase{Medical Imaging}\\
...
\author{
		\textbf{Group K} \\ 
		Francisco Antonio Vilhena Pries de Melo Parente - frvi@itu.dk\\ 
		Mathis Valentin Gravil - mvgr@itu.dk\\ 
		Nicolai Jacob Kofod-Jensen - nkof@itu.dk\\ 
		Raquel Moleiro Marques - raqm@itu.dk}
		% \hline
		% Exam Number: 4\\
		% Character Count: \\
